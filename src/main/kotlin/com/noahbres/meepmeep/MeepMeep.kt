...
open class MeepMeep @JvmOverloads constructor(private val windowSize: Int, fps: Int = 60) {
    ...
    init {
        ...
        FONT_CMU_BOLD_LIGHT = Font.createFont(
            Font.TRUETYPE_FONT, classLoader.getResourceAsStream("font/firacode.ttf")
        ).deriveFont(20f)
        FONT_CMU = Font.createFont(Font.TRUETYPE_FONT, classLoader.getResourceAsStream("font/firacode.ttf"))
        FONT_CMU_BOLD = Font.createFont(Font.TRUETYPE_FONT, classLoader.getResourceAsStream("font/firacode.ttf"))
